...
function __besman_init() {
    ...
    if [[ $flag == true ]]; then
        ...
        export DETAILED_REPORT_PATH="$AUTOCOMPLETE_TEST_REPORT_PATH/$BESMAN_ARTIFACT_NAME:$BESMAN_ARTIFACT_VERSION-detailed-report.json"
